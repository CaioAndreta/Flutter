...
class Questionario extends StatelessWidget {
  ...
  const Questionario({required this.perguntas, required this.perguntaSelecionada, required this.responder, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        // spread da lista de respostas
        ...widgets,

        // //ou é possível utilizar dessa forma
        // for (String textoResp in perguntas[_perguntaSelecionada].cast()['respostas']!)
        //   Resposta(textoResp, _responder)
      ],
    );
  }
}
